...
export const TEXT = {
  ...
  category: {
    ...
    focalLengthShare: '使用 {{focal}} 拍摄的照片',
    year: '年份',
    yearPlural: '年份',
    yearShare: '{{year}} 年的照片',
  ...
  onboarding: {
    ...
    setupSignIn: '登录以上传照片',
    setupFirstPhoto: '添加第一张照片',
    setupConfig: '通过编辑环境变量来更改网站名称和其他配置，参考',
  },
  utility: {
    more: '更多',
    less: '收起',
